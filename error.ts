...
/**
 * This class provides a wrapper for network errors when making requests to Expenses API
 */
export class BrexExpensesError extends Error {
  /**
   * The response body
   */
